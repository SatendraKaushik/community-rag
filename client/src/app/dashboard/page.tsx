...
import { Bot, FileText, ArrowRight, Zap } from 'lucide-react';
...
export default function Dashboard() {
    ...
    return (
        <div className="flex h-screen bg-gray-50 font-sans text-gray-900 overflow-hidden">
            {/* Sidebar */}
            <aside className="w-80 flex-shrink-0 bg-white border-r border-gray-200 flex flex-col shadow-xl z-20">
                <div className="p-6 border-b border-gray-100">
                    <div className="relative flex items-center mb-1">
                        ...
                        />
                        <h1 className="text-2xl font-bold tracking-tight text-gray-900 ml-1">VEDA</h1>
                    </div>
                    <div className="mt-4 px-3 py-1.5 bg-gray-100 rounded-full border border-gray-200 text-xs font-medium text-gray-700 inline-block">
                ...
                {activeTab === 'custom' && !customBotId && (
                    <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-gray-50 to-white">
                        <div className="w-full max-w-2xl">
                            ...
                            <h2 className="text-3xl font-bold text-center mb-3 text-gray-900">Create Your Custom Bot</h2>
                            <p className="text-center text-gray-600 mb-8 text-lg">
                                Paste your content below. We'll use RAG to create a specialized assistant instantly.
                            </p>

                            <textarea
                                className="w-full h-64 p-5 rounded-2xl border-2 border-gray-300 text-base focus:ring-2 focus:ring-gray-500 focus:border-gray-500 outline-none mb-6 bg-white resize-none shadow-sm transition-all"
                            ...
                            <Button
                                ...
                                className="w-full h-14 text-lg bg-gray-800 hover:bg-gray-900 shadow-lg hover:shadow-xl transition-all"
                            >
                                {isCreatingBot ? 'Training AI Model...' : 'Build Assistant'} <ArrowRight className="w-6 h-6 ml-2" />
                            </Button>
                        </div>
                    </div>
                )}
                    ...
                    {activeTab === 'custom' && customBotId && (
                        <div className="h-full w-full relative">
                            ...
                            <button
                                ...
                                className="absolute top-4 right-4 text-sm font-medium text-blue-500 hover:text-blue-700 flex items-center gap-1 bg-white px-3 py-1 rounded-full shadow-sm border border-blue-100"
                            >
